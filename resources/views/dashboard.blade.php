                        ...
                        @if($products->count())
                            @foreach ($products as $product )
                                <tr>
                                    ...
                                    <td>@if ($product->image!="")
                                        <img src="{{asset('uploads/products/'.$product->image)}}" alt="product image" width="30px">
                                    @endif</td>
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#buyModal-{{$product->id}}">Buy</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="buyModalLabel-{{ $product->id }}">Buy Product</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ route('account.buy', $product->id) }}" method="POST">
                                                            @csrf
                                                            <div class="mb-3">
